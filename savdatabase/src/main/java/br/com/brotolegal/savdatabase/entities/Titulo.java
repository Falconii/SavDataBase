...
public class Titulo extends ObjRegister {
	...
	protected static final String _OBJETO = "br.com.brotolegal.savdatabase.entities.Titulo";


	public Titulo(){

		super(_OBJETO,"TITULO");
	...
	public Titulo(String FILIAL, String PREFIXO, String NUM, String PARCELA, String TIPO, String CLIENTE, String LOJA, String RAZAO, String REDE, String EMISSAO, Float VALOR, String VENCTO, String PAGTO, Float SALDO, Float DESCCONTRATO, String BANCO, String AGENCIA, String NROBANCARIO, String LINHADIGITAVEL) {
